...
$router->get("/nosotros", [PaginasController::class, "aboutus"]);
$router->get("/propiedades", [PaginasController::class, "properties"]);
$router->get("/propiedad", [PaginasController::class, "property"]);
$router->get("/blog", [PaginasController::class, "blog"]);
$router->get("/entrada", [PaginasController::class, "entry"]);
$router->get("/contacto", [PaginasController::class, "contact"]);
$router->post("/contacto", [PaginasController::class, "contact"]);
//authentication
